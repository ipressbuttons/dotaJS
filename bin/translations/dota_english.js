define({"lang": {
    ...
    "Tokens": {
        ...
        "DOTA_Tutorial_M1_UsePotion": "Healing Salves are Active Items, so you need use them on a target. Left-click on the Salve in your inventory to get a targeting cursor, then left-click on yourself to drink it.\n\nYou can also hit the %dota_item_execute 0% key to use the item in your first inventory slot (in this case the Salve). Hitting that key twice will immediately use and target it on yourself.",
